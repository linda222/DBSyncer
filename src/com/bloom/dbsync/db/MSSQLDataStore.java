...
public class MSSQLDataStore extends DataStore {
	...
	public MSSQLDataStore(String dsLogicalName, String dsConnectionUrl) throws SQLException {
	...
	public void closeMSSConnection() {
		try {
			if (this.MSSQLConnection != null)
				this.MSSQLConnection.close();
		} catch (SQLException sqlEx) {
			this.logger.logClass.error("Failed to close sqlserver DB connection " + this.dsConnectionUrl + ". Error: "
					+ sqlEx.getMessage());
		}
